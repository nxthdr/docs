...
```bibtex
@misc{nxthdr2024,
  title        = {{nxthdr}: An Open Platform for Internet Research},
  author       = {Matthieu Gouel},
  year         = {2024},
  howpublished = {\url{https://nxthdr.dev}},
  note         = {An open platform for Internet peering, measurements, and research collaboration},
}
```

## Contact for Citations

For questions about citations or to report publications using nxthdr, please [reach out](/docs/reference/contact) to us.
...
> This work was supported by data and infrastructure provided by nxthdr (https://nxthdr.dev), an open platform for Internet research.
