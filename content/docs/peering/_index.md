...
Combine [Saimiris](/docs/probing/) with PeerLab to conduct unique experiments. Study how routing changes affect reachability, latency, and path selection in real-time.

**Reproducible Research**

Validate and reproduce prior studies with access to consistent infrastructure and open datasets. All routing data is made freely available through our public [datasets](/docs/datasets/).
